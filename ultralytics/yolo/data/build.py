...
from .dataset import YOLODataset, HHVDataset
...
def build_hhv_dataset(cfg, img_path, batch, data, mode='train', rect=False, stride=32):
    """Build Hubmap Hacking Human Vessel Dataset"""
    return HHVDataset(
        img_path=img_path,
        imgsz=cfg.imgsz,
        batch_size=batch,
